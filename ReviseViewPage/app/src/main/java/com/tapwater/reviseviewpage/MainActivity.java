package com.tapwater.reviseviewpage;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener{
    ...
    private void initViews() {
        vpager_four = (ViewPager) findViewById(R.id.viewPagePlace);
        tv_one = (TextView) findViewById(R.id.textViewOne);
        tv_two = (TextView) findViewById(R.id.textViewTwo);
        tv_three = (TextView) findViewById(R.id.textViewThree);
        tv_three = (TextView) findViewById(R.id.textViewFour);
        img_cursor = (ImageView) findViewById(R.id.imageViewPlace);

        //下划线动画的相关设置：
        bmpWidth = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher).getWidth();// 获取图片宽度
